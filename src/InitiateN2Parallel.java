...
class InitiateN2Parallel {
    ...
    InitiateN2Parallel(Body[] bodies, int dt, int numberOfBodies, int workers, Vector[] forces, int numSteps) {
        this.bodies = bodies;
        this.dt = dt;
    ...
    void initiate() {
        ...
        for (int i = 0; i < workers; i++) {
            worker[i] = new Worker(w, bodies, dt, simulation);
